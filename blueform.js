...
<div class="bf-row" style="font-size:9px;">
    ...
    <div>
        ...
        <div style="position:relative;">
            ...
            ${stampImages.exec_signature?.date ? `<span style="position:absolute;right:200px;top:-18px;font-size:10px;color:#000;white-space:nowrap;">${formatShortDate(stampImages.exec_signature.date)}</span>` : ''}
        </div>
    ...
    <div>
        ...
        <div style="height:70px; position:relative;">
            ${stampImages.section_head?.signature ? `<img src="${stampImages.section_head.signature}" style="max-height:60px; max-width:150px; object-fit:contain; position:absolute; bottom:0; left:5%;">` : ''}
        </div>
        <div style="position:relative;">
            <div class="bf-sign-line"></div>
    ...
    <div>
        ...
        <div style="height:70px; position:relative;">
            ${stampImages.dept_head?.signature ? `<img src="${stampImages.dept_head.signature}" style="max-height:60px; max-width:150px; object-fit:contain; position:absolute; bottom:0; left:5%;">` : ''}
        </div>
        <div style="position:relative;">
            <div class="bf-sign-line"></div>
            ${stampImages.dept_head?.date ? `<span style="position:absolute;right:200px;top:-18px;font-size:10px;color:#000;white-space:nowrap;">${formatShortDate(stampImages.dept_head.date)}</span>` : ''}
        </div>
        <small style="display:block; margin-top:2px;">
