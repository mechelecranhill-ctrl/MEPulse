...
<div class="bf-row" style="font-size:9px;">
    ...
    <div>
        ...
        <div style="height:70px; position:relative;">
            ${stampImages.section_head?.signature ? `<img src="${stampImages.section_head.signature}" style="max-height:50px; max-width:120px; object-fit:contain; position:absolute; bottom:0; left:5%;">` : ''}
        </div>
        <div style="position:relative;">
            <div class="bf-sign-line"></div>
    ...
    <div>
        ...
        <div style="height:70px; position:relative;">
            ${stampImages.dept_head?.signature ? `<img src="${stampImages.dept_head.signature}" style="max-height:50px; max-width:120px; object-fit:contain; position:absolute; bottom:0; left:5%;">` : ''}
        </div>
        <div style="position:relative;">
            <div class="bf-sign-line"></div>
