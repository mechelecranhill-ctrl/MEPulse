...
<div class="bf-row" style="font-size:9px;">
    ...
    <div>
        ...
        <div style="position:relative;">
            ...
            ${stampImages.exec_signature?.date ? `<span style="position:absolute;right:50px;top:-18px;font-size:10px;color:#000;white-space:nowrap;">${formatShortDate(stampImages.exec_signature.date)}</span>` : ''}
        </div>
    ...
    <div>
        ...
        <div style="position:relative;">
            <div class="bf-sign-line"></div>
            ${stampImages.section_head?.date ? `<span style="position:absolute;right:50px;top:-18px;font-size:10px;color:#000;white-space:nowrap;">${formatShortDate(stampImages.section_head.date)}</span>` : ''}
        </div>
        <small style="display:block; margin-top:2px;">
    ...
    <div>
        ...
        <div style="position:relative;">
            <div class="bf-sign-line"></div>
            ${stampImages.dept_head?.date ? `<span style="position:absolute;right:50px;top:-18px;font-size:10px;color:#000;white-space:nowrap;">${formatShortDate(stampImages.dept_head.date)}</span>` : ''}
        </div>
        <small style="display:block; margin-top:2px;">
